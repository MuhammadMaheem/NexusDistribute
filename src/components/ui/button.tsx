  ...
  'group relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        glow: 'bg-gradient-to-br from-primary to-primary/80 text-primary-foreground shadow-glow-sm hover:shadow-glow hover:-translate-y-0.5 active:translate-y-0',
        ...
        // Ghost — minimal
        ghost: 'text-text-secondary hover:bg-surface-2/50 hover:text-foreground',
      ...
      size: {
        default: 'h-10 px-4 py-2 sm:h-9 sm:px-4',
        sm: 'h-9 rounded-md px-3 text-xs sm:h-8',
        lg: 'h-12 rounded-xl px-6 text-sm md:px-8 md:text-base',
        icon: 'h-10 w-10 sm:h-9 sm:w-9',
        'icon-sm': 'h-9 w-9 sm:h-8 sm:w-8',
        'icon-lg': 'h-12 w-12 sm:h-11 sm:w-11',
        responsive:
          'h-9 rounded-md px-3 text-xs sm:h-10 sm:rounded-lg sm:px-4 sm:text-sm lg:h-11 lg:px-6',
      },
    },
    defaultVariants: {
      variant: 'glow',
