        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center justify-between border-b border-border/30 px-5">
            <div className="flex items-center gap-2.5">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-delivery to-delivery/60 shadow-[0_0_8px_hsl(var(--delivery-glow)/0.2)]">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border/30 bg-background/80 backdrop-blur-xl px-4 lg:px-6">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <ThemeToggle />
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-delivery to-delivery/60 shadow-[0_0_8px_hsl(var(--delivery-glow)/0.2)]">
